# D-PlaneOS v3.2.1 Installation Guide
...
wget https://github.com/4nonX/D-PlaneOS/releases/download/v3.2.1/dplaneos-v3.2.1.tar.gz

# Verify SHA256
sha256sum dplaneos-v3.2.1.tar.gz
...
**Note:** v3.2.1 is backward compatible. Upgrade preserves all data and configuration.
